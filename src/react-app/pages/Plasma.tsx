  ...
  const preview = (
    <div className="h-[500px] w-full relative bg-[#060010] rounded-lg overflow-hidden border border-gray-800 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-black text-white mix-blend-overlay opacity-80 tracking-tighter">PLASMA</h1>
      </div>
    </div>
  );
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700 flex-1 h-10 mt-6">
            <label className="text-sm font-medium text-gray-300">Mouse Interactive</label>
            <input
              type="checkbox"
...
export default Plasma;`;
  ...
  const props = [
    {
      ...
      type: 'string',
      default: "'#ffffff'",
      description: 'Base color of the plasma',
    },
    {
      name: 'speed',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '1',
      description: 'Scale of the plasma pattern',
    },
    {
      name: 'opacity',
      type: 'number',
      default: '1',
      description: 'Opacity of the effect',
    },
    {
  ...
  return (
    <ComponentDetail
      title="Plasma"
      description="A psychedelic plasma shader effect using OGL."
      preview={preview}
