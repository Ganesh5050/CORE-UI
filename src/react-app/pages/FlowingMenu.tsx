...
export default function FlowingMenuPage() {
  return (
    <ComponentDetail
      title="Flowing Menu"
      description="Menu with flowing animations"
      preview={<FlowingMenuPreview />}
      code={codeExample}
      usage={usageCode}
      props={props}
