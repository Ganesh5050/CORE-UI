...
const DarkVeilPage = () => {
  ...
  const [scanlineFrequency, setScanlineFrequency] = useState(500);
  ...
  const preview = (
    <div className="h-[500px] w-full relative bg-[#060010] rounded-lg overflow-hidden border border-gray-800 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-black text-white mix-blend-overlay opacity-80 tracking-tighter">DARK VEIL</h1>
      </div>
    </div>
  );
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Hue Shift ({hueShift}°)</label>
          <input
            type="range"
            min="0"
            max="360"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Noise Intensity ({noiseIntensity})</label>
          <input
            type="range"
            min="0"
            max="1"
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Scanline Intensity ({scanlineIntensity})</label>
          <input
            type="range"
            min="0"
            max="1"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Scanline Frequency ({scanlineFrequency})</label>
          <input
            type="range"
            min="100"
            max="1000"
            ...
            onChange={(e) => setScanlineFrequency(parseInt(e.target.value))}
            className="w-full bg-gray-800 rounded-lg appearance-none h-2 cursor-pointer"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Warp Amount ({warpAmount})</label>
          <input
            type="range"
            min="0"
            max="2"
...
`;
  ...
  const props = [
    {
      ...
      type: 'number',
      default: '0',
      description: 'Shift the hue of the colors',
    },
    {
      name: 'noiseIntensity',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '0.1',
      description: 'Intensity of the scanlines',
    },
    {
      name: 'speed',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '0.5',
      description: 'Amount of warping effect',
    },
    {
  ...
  return (
    <ComponentDetail
      title="Dark Veil"
      description="A dark, mysterious background effect with scanlines and noise."
      preview={preview}
