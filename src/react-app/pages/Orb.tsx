...
const OrbPage = () => {
  ...
  const preview = (
    <div className="h-[600px] w-full bg-[#060010] rounded-lg overflow-hidden border border-gray-800">
      <Orb
        hue={hue}
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Hue ({hue}°)</label>
          <input
            type="range"
            min="0"
            max="360"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Hover Intensity ({hoverIntensity})</label>
          <input
            type="range"
            min="0"
            max="1"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700">
          <label className="text-sm font-medium text-gray-300">Rotate on Hover</label>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700">
          <label className="text-sm font-medium text-gray-300">Force Hover State</label>
          <input
            type="checkbox"
...
export default function Orb({
  ...
  useEffect(() => {
    ...
    // ... resize, mouse handling, animation loop
  ...
  const props = [
    ...
    },
    {
      ...
      type: 'number',
      default: '0.2',
      description: 'Intensity of the hover distortion effect',
    },
    {
      name: 'rotateOnHover',
      type: 'boolean',
      default: 'true',
      description: 'Enable rotation animation when hovering over the orb',
    },
    {
      name: 'forceHoverState',
      type: 'boolean',
      default: 'false',
      description: 'Force the hover state to be always active',
    },
  ];
  ...
  return (
    <ComponentDetail
      title="Orb"
      description="A mesmerizing WebGL orb with dynamic lighting, noise-based animation, and interactive hover effects. Built with OGL."
      preview={preview}
