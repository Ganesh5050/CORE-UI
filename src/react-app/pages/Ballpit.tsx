...
const BallpitPage = () => {
  ...
  const preview = (
    <div className="h-[500px] w-full relative bg-[#060010] rounded-lg overflow-hidden border border-gray-800 flex items-center justify-center">
      <div className="w-full h-full">
        <Ballpit
          key={`${count}-${gravity}-${friction}-${wallBounce}-${followCursor}-${color1}-${color2}-${color3}`}
          count={count}
          gravity={gravity}
          friction={friction}
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-black text-white mix-blend-overlay opacity-80 tracking-tighter">BALLPIT</h1>
      </div>
    </div>
  );
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Count ({count})</label>
          <input
            type="range"
            min="50"
            max="500"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Gravity ({gravity})</label>
          <input
            type="range"
            min="0"
            max="2"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Friction ({friction})</label>
          <input
            type="range"
            min="0.1"
            max="1"
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Wall Bounce ({wallBounce})</label>
          <input
            type="range"
            min="0"
            max="1"
            step="0.01"
            value={wallBounce}
            onChange={(e) => setWallBounce(parseFloat(e.target.value))}
            className="w-full bg-gray-800 rounded-lg appearance-none h-2 cursor-pointer"
          />
        </div>
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex-1">
            <label className="block text-sm font-medium text-gray-400 mb-1">Color 3</label>
            <input
              type="color"
              value={color3}
        ...
        <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700 h-10 mt-6">
          <label className="text-sm font-medium text-gray-300">Follow Cursor</label>
          <input
            type="checkbox"
  ...
  const usageCode = `import Ballpit from './Ballpit';
...
export default Ballpit;`;
  ...
  const props = [
    ...
    },
    {
      ...
      type: 'number',
      default: '0.95',
      description: 'Bounciness of walls (0-1)',
    },
    {
      name: 'followCursor',
      type: 'boolean',
      default: 'true',
      description: 'Enable cursor interaction',
    },
    {
      name: 'colors',
      type: 'number[]',
  ...
  return (
    <ComponentDetail
      title="Ballpit"
      description="A physics-based interactive ballpit simulation using Three.js."
      preview={preview}
