...
export default function PrismaticBurstPage() {
  return (
    <ComponentDetail
      ...
      description="Prismatic burst animation"
      preview={<PrismaticBurstPreview />}
      code={codeExample}
      usage={usageCode}
      props={props}
      dependencies={[]}
