  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Base Width ({baseWidth}px)</label>
          <input
            type="range"
            min="200"
            max="500"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Autoplay Delay ({autoplayDelay}ms)</label>
          <input
            type="range"
            min="1000"
            max="10000"
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg border border-gray-700">
          <label className="text-sm font-medium text-gray-300">Round Style</label>
          <input
            type="checkbox"
            checked={round}
...
/>`;
  ...
  const codeExample = `import { useEffect, useState, useRef } from 'react';
...
`;
  ...
  const props = [
    ...
    },
    {
      ...
      type: 'number',
      default: '3000',
      description: 'Delay between slides in ms',
    },
    {
      name: 'pauseOnHover',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Use round styling for items',
    },
  ];
  ...
  return (
    <ComponentDetail
      title="Carousel"
      description="A draggable 3D carousel with autoplay and infinite loop capabilities."
      preview={preview}
