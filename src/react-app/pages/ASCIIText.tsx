...
import ASCIITextComponent from '../components/text/ASCIIText';
import Slider from '../components/Slider';

const ASCIITextPreview = ({
  asciiFontSize = 8
}: {
...
const codeExample = `// Component ported and enhanced from https://codepen.io/JuanFuentes/pen/eYEeoyE
...
const props = [
  ...
  },
  {
    ...
    type: 'number',
    default: '8',
    description: 'Font size of ASCII characters',
  },
  {
    name: 'textFontSize',
    type: 'number',
    default: '200',
    description: 'Font size of the main text',
  },
  {
    name: 'textColor',
    type: 'string',
  ...
  },
  {
    ...
    type: 'number',
    default: '8',
    description: 'Base height of the 3D plane',
  },
  {
    name: 'enableWaves',
    type: 'boolean',
...
export default function ASCIIText() {
  ...
  return (
    <ComponentDetail
      title="ASCII Text"
      description="3D text rendered with ASCII characters using Three.js with wave animations and mouse interaction"
      preview={<ASCIITextPreview asciiFontSize={asciiFontSize} />}
      code={codeExample}
      props={props}
