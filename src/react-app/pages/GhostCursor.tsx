...
import GhostCursor from '@/react-app/components/effects/GhostCursor';

const GhostCursorPreview = () => {
  return (
    <div style={{ height: '600px', position: 'relative', backgroundColor: '#0a0a0a', borderRadius: '12px', overflow: 'hidden' }}>
      <GhostCursor
        color="#B19EEF"
        brightness={1}
        edgeIntensity={0}
...
const usageExample = `import GhostCursor from './GhostCursor';
...
const codeExample = `import React, { useEffect, useMemo, useRef } from 'react';
...
const props = [
  ...
  },
  {
    ...
    type: 'number',
    default: '50',
    description: 'Number of trail positions to track',
  },
  {
    name: 'inertia',
    type: 'number',
    default: '0.5',
    description: 'Inertia factor for smooth movement (0-1)',
  },
  {
    name: 'grainIntensity',
    type: 'number',
    default: '0.05',
    description: 'Film grain effect intensity',
  },
  {
    name: 'bloomStrength',
    type: 'number',
    default: '0.1',
    description: 'Bloom post-processing strength',
  },
  {
    name: 'bloomRadius',
    type: 'number',
  ...
  },
  {
    ...
    type: 'string',
    default: "'#B19EEF'",
    description: 'Base color of the ghost cursor',
  },
  {
    name: 'mixBlendMode',
    type: "React.CSSProperties['mixBlendMode']",
    default: "'screen'",
    description: 'CSS mix-blend-mode for the canvas',
  },
  {
    name: 'edgeIntensity',
    type: 'number',
    default: '0',
    description: 'Edge vignette intensity (0-1)',
  },
  {
    name: 'maxDevicePixelRatio',
    type: 'number',
    default: '0.5',
    description: 'Maximum device pixel ratio for performance',
  },
  {
    name: 'targetPixels',
    type: 'number',
    default: 'auto (0.9M touch, 1.3M desktop)',
    description: 'Target pixel budget for rendering',
  },
  {
    name: 'fadeDelayMs',
    type: 'number',
    default: 'auto (500 touch, 1000 desktop)',
    description: 'Delay before fade-out starts (ms)',
  },
  {
    name: 'fadeDurationMs',
    type: 'number',
    default: 'auto (1000 touch, 1500 desktop)',
  ...
  },
  {
    ...
    type: 'number',
    default: '10',
    description: 'CSS z-index of the cursor overlay',
  },
];
...
export default function GhostCursorPage() {
  return (
    <ComponentDetail
      title="Ghost Cursor"
      description="Smoky, ethereal cursor trail effect with WebGL shaders and post-processing"
      preview={<GhostCursorPreview />}
      code={codeExample}
      usage={usageExample}
      props={props}
      dependencies={['three']}
