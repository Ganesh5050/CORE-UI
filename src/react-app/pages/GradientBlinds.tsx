...
export default function GradientBlindsPage() {
  return (
    <ComponentDetail
      ...
      description="Gradient blinds transition effect"
      preview={<GradientBlindsPreview />}
      code={codeExample}
      usage={usageCode}
      props={props}
      dependencies={[]}
