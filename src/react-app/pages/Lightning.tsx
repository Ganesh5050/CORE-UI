  ...
  const preview = (
    <div className="h-[500px] w-full relative bg-[#060010] rounded-lg overflow-hidden border border-gray-800 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-black text-white mix-blend-overlay opacity-80 tracking-tighter">LIGHTNING</h1>
      </div>
    </div>
  );
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">X Offset ({xOffset})</label>
          <input
            type="range"
            min="-1"
            max="1"
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Intensity ({intensity})</label>
          <input
            type="range"
            min="0.1"
            max="2"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Size ({size})</label>
          <input
            type="range"
            min="0.5"
            max="2"
...
export default Lightning;`;
  ...
  const props = [
    {
      ...
      type: 'number',
      default: '230',
      description: 'Color hue of the lightning (0-360)',
    },
    {
      name: 'xOffset',
      type: 'number',
    ...
    },
    {
      ...
      type: 'number',
      default: '1',
      description: 'Scale of the lightning pattern',
    },
  ];
  ...
  return (
    <ComponentDetail
      title="Lightning"
      description="A procedural lightning bolt effect using raw WebGL shaders."
      preview={preview}
