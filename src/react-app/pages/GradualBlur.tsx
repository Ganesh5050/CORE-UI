...
import GradualBlur from '@/react-app/components/effects/GradualBlur';

const GradualBlurPreview = () => {
  return (
    <div style={{ position: 'relative', height: '500px', overflow: 'hidden', backgroundColor: '#111', borderRadius: '12px' }}>
      <div style={{ height: '100%', overflowY: 'auto', padding: '2rem' }}>
        <h2 style={{ color: 'white', marginBottom: '1rem' }}>Scrollable Content</h2>
...
const usageExample = `import GradualBlur from './GradualBlur';
...
const codeExample = `import React, { useEffect, useRef, useState, useMemo } from 'react';
...
const props = [
  {
    ...
    default: "'bottom'",
    description: 'Position of the blur gradient',
  },
  {
    name: 'strength',
    type: 'number',
  ...
  },
  {
    ...
    type: 'string',
    default: "'6rem'",
    description: 'Height/width of the blur area',
  },
  {
    name: 'divCount',
    type: 'number',
    default: '5',
    description: 'Number of layers for the gradient smoothness',
  },
  {
    name: 'curve',
    type: "'linear' | 'bezier' | 'ease-in' | 'ease-out' | 'ease-in-out'",
    default: "'linear'",
    description: 'Easing curve for the blur gradient',
  },
  {
    name: 'exponential',
    type: 'boolean',
    default: 'false',
    description: 'Use exponential blur calculation',
  },
  {
    name: 'opacity',
    type: 'number',
    default: '1',
    description: 'Opacity of the blur layers',
  },
  {
    name: 'target',
    type: "'parent' | 'page'",
    default: "'parent'",
    description: 'Whether to blur relative to parent or fixed to page',
  },
];
...
export default function GradualBlurPage() {
  return (
    <ComponentDetail
      title="Gradual Blur"
      description="A smooth, layered blur gradient effect for masking content edges"
      preview={<GradualBlurPreview />}
      code={codeExample}
      usage={usageExample}
      props={props}
      dependencies={['mathjs']}
