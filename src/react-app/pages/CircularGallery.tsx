...
const CircularGalleryPage = () => {
  ...
  const [font, setFont] = useState('bold 30px Figtree');

  const preview = (
    <div className="h-[600px] w-full relative bg-[#111] rounded-lg overflow-hidden">
      <CircularGallery
        bend={bend}
        textColor={textColor}
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Bend ({bend})</label>
          <input
            type="range"
            min="-5"
            max="5"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Border Radius ({borderRadius})</label>
          <input
            type="range"
            min="0"
            max="0.2"
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-300 font-mono">{textColor}</span>
          </div>
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Font</label>
          <input
            type="text"
            value={font}
  ...
  const usageCode = `import CircularGallery from './CircularGallery';
...
/>`;
  ...
  const codeExample = `import { Camera, Mesh, Plane, Program, Renderer, Texture, Transform } from 'ogl';
...
`;
  ...
  const props = [
    ...
    },
    {
      ...
      type: 'number',
      default: '3',
      description: 'Curvature of the gallery',
    },
    {
      name: 'textColor',
      type: 'string',
    ...
    },
    {
      ...
      description: 'Font string for the text labels',
    },
  ];
  ...
  return (
    <ComponentDetail
      ...
      description="A 3D circular image gallery with smooth scrolling and curvature effects using OGL."
      preview={preview}
