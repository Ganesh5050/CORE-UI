...
import ShuffleComponent from '../components/text/Shuffle';
...
const ShufflePreview = ({
  ...
  return (
    <div className="text-center py-12">
      ...
      />
      <p className="text-sm text-gray-400 mt-4">Scroll or hover to shuffle</p>
    </div>
  );
};

const codeExample = `import React, { useRef, useEffect, useState } from 'react';
...
const usageExample = `import Shuffle from './Shuffle';
...
const props = [
  ...
  },
  {
    ...
    type: 'number',
    default: '1',
    description: 'Number of times to shuffle each character',
  },
  {
    name: 'stagger',
    type: 'number',
  ...
  },
  {
    ...
    type: 'boolean',
    default: 'true',
    description: 'Trigger animation on hover',
  },
];
...
export default function Shuffle() {
  ...
  return (
    <ComponentDetail
      title="Shuffle"
      description="Text reveal animation with random character shuffling effect triggered on hover"
      preview={<ShufflePreview duration={duration} shuffleTimes={shuffleTimes} />}
      code={codeExample}
      usage={usageExample}
      props={props}
