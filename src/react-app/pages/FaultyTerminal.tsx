...
export default function FaultyTerminalPage() {
  return (
    <ComponentDetail
      ...
      description="Glitchy terminal effect"
      preview={<FaultyTerminalPreview />}
      code={codeExample}
      usage={usageCode}
      props={props}
      dependencies={[]}
