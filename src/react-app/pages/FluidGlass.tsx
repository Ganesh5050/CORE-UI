...
const FluidGlassPage = () => {
  ...
  const preview = (
    <div className="h-[600px] w-full relative bg-gray-900 rounded-lg overflow-hidden border border-gray-800">
      <div className="absolute top-4 left-4 z-10 bg-black/50 p-4 rounded text-white text-sm max-w-md backdrop-blur-sm pointer-events-none">
        <p className="font-bold text-yellow-400 mb-2">⚠️ Asset Requirement</p>
        <p>
          This component requires 3D models and images to be placed in the <code>public/assets</code> directory.
        </p>
        <ul className="list-disc list-inside mt-2 text-xs text-gray-300">
          <li>public/assets/3d/lens.glb</li>
          <li>public/assets/3d/cube.glb</li>
          <li>public/assets/3d/bar.glb</li>
          <li>public/assets/demo/cs1.webp (and cs2, cs3)</li>
        </ul>
      </div>
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Scale ({scale})</label>
          <input
            type="range"
            min="0.1"
            max="1"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">IOR ({ior})</label>
          <input
            type="range"
            min="1"
            max="2.33"
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Thickness ({thickness})</label>
          <input
            type="range"
            min="0"
            max="10"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Chromatic Aberration ({chromaticAberration})</label>
          <input
            type="range"
            min="0"
            max="1"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Anisotropy ({anisotropy})</label>
          <input
            type="range"
            min="0"
            max="1"
  ...
  const usageCode = `// IMPORTANT: Ensure you have the required 3D assets in public/assets/3d/
// - lens.glb, bar.glb, cube.glb

import FluidGlass from './FluidGlass'

<div style={{ height: '600px', position: 'relative' }}>
  <FluidGlass 
    mode="${mode}" // "lens" | "bar" | "cube"
    lensProps={{
      scale: ${scale},
      ior: ${ior},
      thickness: ${thickness},
...
`;
  ...
  const props = [
    {
      ...
      type: "'lens' | 'bar' | 'cube'",
      default: "'lens'",
      description: 'The shape/mode of the glass effect',
    },
    {
      name: 'lensProps',
      type: 'object',
      default: '{}',
      description: 'Properties for the lens mode (scale, ior, thickness, etc.)',
    },
    {
      name: 'barProps',
      type: 'object',
      default: '{}',
      description: 'Properties for the bar mode',
    },
    {
      name: 'cubeProps',
      type: 'object',
      default: '{}',
      description: 'Properties for the cube mode',
    },
  ];
  ...
  return (
    <ComponentDetail
      title="Fluid Glass"
      description="Interactive 3D glass effect with scroll-based animations and transmission materials."
      preview={preview}
