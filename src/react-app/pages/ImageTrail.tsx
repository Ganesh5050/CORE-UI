...
const images = [
  ...
  'https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614850523018-c41484b85129?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614851099511-773084f6911d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614850523296-d8c1af93d400?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614850523459-c2f4c699c52e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614850523018-c41484b85129?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614851099511-773084f6911d?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
  'https://images.unsplash.com/photo-1614850523296-d8c1af93d400?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80',
...
const ImageTrailPreview = ({ variant = 1 }: { variant?: number }) => {
  return (
...
export default function ImageTrailPage() {
  ...
  const customization = (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <label className="text-sm font-medium text-gray-400">Variant</label>
        <div className="flex flex-wrap gap-2">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((v) => (
            <button
              key={v}
              onClick={() => setVariant(v)}
              className={`px-3 py-1 rounded text-sm ${variant === v
                ? 'bg-white text-black'
  ...
  return (
    <ComponentDetail
      title="Image Trail"
      description="A mouse trail effect that reveals a sequence of images as you move the cursor, with multiple animation variants."
      preview={<ImageTrailPreview variant={variant} />}
      code={codeExample}
      props={props}
