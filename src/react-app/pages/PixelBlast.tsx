...
const PixelBlastPage = () => {
  ...
  const preview = (
    <div className="h-[500px] w-full relative bg-[#060010] rounded-lg overflow-hidden border border-gray-800 flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h1 className="text-6xl font-black text-white mix-blend-overlay opacity-80 tracking-tighter">PIXEL BLAST</h1>
      </div>
    </div>
  );
  ...
  const customization = (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Pixel Size ({pixelSize})</label>
          <input
            type="range"
            min="1"
            max="20"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Pattern Scale ({patternScale})</label>
          <input
            type="range"
            min="1"
            max="10"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Pattern Density ({patternDensity})</label>
          <input
            type="range"
            min="0"
            max="3"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Pixel Jitter ({pixelSizeJitter})</label>
          <input
            type="range"
            min="0"
            max="1"
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Ripple Speed ({rippleSpeed})</label>
          <input
            type="range"
            min="0.1"
            max="2"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-1">Liquid Strength ({liquidStrength})</label>
          <input
            type="range"
            min="0"
            max="0.5"
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col gap-2 flex-1 mt-6">
            <div className="flex items-center justify-between p-2 bg-gray-800/50 rounded-lg border border-gray-700">
              <label className="text-sm font-medium text-gray-300">Ripples</label>
              <input
                type="checkbox"
            ...
            <div className="flex items-center justify-between p-2 bg-gray-800/50 rounded-lg border border-gray-700">
              <label className="text-sm font-medium text-gray-300">Liquid</label>
              <input
                type="checkbox"
                checked={liquid}
  ...
  const usageCode = `import PixelBlast from './PixelBlast';
...
export default PixelBlast;`;
  ...
  const props = [
    {
      ...
      default: "'square'",
      description: 'Shape of the pixels (square, circle, triangle, diamond)',
    },
    {
      name: 'pixelSize',
      type: 'number',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'true',
      description: 'Enable ripple effect on click/hover',
    },
    {
      name: 'liquid',
      type: 'boolean',
  ...
  return (
    <ComponentDetail
      title="Pixel Blast"
      description="An interactive WebGL pixelated background with ripple and liquid effects."
      preview={preview}
